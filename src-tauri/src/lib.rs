...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::svn_log_command,
            commands::svn_show_detail,
            commands::svn_resolve,
            commands::svn_resolve_accept,
            commands::svn_update_force,
            commands::svn_update_force_streaming_cmd,
            commands::svn_revert,
